                        ...
                        <div class="section-card">
                            ...
                            <div class="section-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div v-if="thumbnailPreview || form.thumbnail_path" class="thumbnail-preview">
                                        <img :src="thumbnailPreview || form.thumbnail_path" />
...
export default {
    ...
    methods: {
        ...
        openThumbCropper() {
            this.thumbCropperSrc = this.thumbnailPreview || this.form.thumbnail_path;
            this.thumbCropperOpen = true;
        },
        ...
        cancelThumbCrop() {
            this.thumbCropperOpen = false;
            if (!this.thumbnailFile && !this.form.thumbnail_path) {
